...
import { loadMiniCeilingLampModel } from "./modules/miniCeilingLamp.js";
...
loadMiniCeilingLampModel(scene);

setupVR(renderer); // Ensure this is called after renderer is created
